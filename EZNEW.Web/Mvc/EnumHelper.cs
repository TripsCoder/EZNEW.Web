...
namespace EZNEW.Web.Mvc
{
    public static class EnumHelper
    {
        ...
        /// <paramref name="type"/>.
        /// </remarks>
        public static IList<SelectListItem> GetSelectList(Type type, params Enum[] currentValues)
        {
        ...
        public static IList<SelectListItem> GetSelectList(Type type, List<string> selectedValues)
        {
            if (type == null)
            {
